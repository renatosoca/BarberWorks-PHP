<header class="border-b border-gray-500" >
  <div class="max-w-[80rem] flex justify-between mx-auto py-3 px-4 text-[#64B5F6]">
    <div class="text-3xl  font-bold font-Gotham">
      Barber Works
    </div>

    <div class="flex gap-1 items-center">
      <p class="text-gray-300" ><?php echo $name . ' ' . $lastname; ?></p>
